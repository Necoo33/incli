            ...
            match self.os_type {
                OsType::Windows => {
                    match self.third_arg.as_str() {
                        "lts" => go::install_go_on_windows("https://go.dev/dl/go1.22.1.windows-amd64.msi", "go1.22.1.windows-amd64.msi"),
                        "" => go::install_go_on_windows("https://go.dev/dl/go1.22.1.windows-amd64.msi", "go1.22.1.windows-amd64.msi"),
                ...
                OsType::Linux => {
                    ...
                    match linux_dist {
                        "ubuntu" => {
                            match self.third_arg.as_str() {
                                "lts" => go::install_go_on_debian_based_distros("https://go.dev/dl/go1.22.1.linux-amd64.tar.gz", "go1.22.1.linux-amd64.tar.gz"),
                                "" => go::install_go_on_debian_based_distros("https://go.dev/dl/go1.22.1.linux-amd64.tar.gz", "go1.22.1.linux-amd64.tar.gz"),
                        ...
                        "arch wsl" => {
                            match self.third_arg.as_str() {
                                "lts" => go::install_go_on_arch_linux("https://go.dev/dl/go1.22.1.linux-amd64.tar.gz", "go1.22.1.linux-amd64.tar.gz"),
                                "" => go::install_go_on_arch_linux("https://go.dev/dl/go1.22.1.linux-amd64.tar.gz", "go1.22.1.linux-amd64.tar.gz"),
                        ...
                        "fedora" => {
                            match self.third_arg.as_str() {
                                "lts" => go::install_go_on_centos_and_fedora("https://go.dev/dl/go1.22.1.linux-amd64.tar.gz", "go1.22.1.linux-amd64.tar.gz"),
                                "" => go::install_go_on_centos_and_fedora("https://go.dev/dl/go1.22.1.linux-amd64.tar.gz", "go1.22.1.linux-amd64.tar.gz"),
                        ...
                        "alma linux" => {
                            match self.third_arg.as_str() {
                                "lts" => go::install_go_on_alma_linux("https://go.dev/dl/go1.22.1.linux-amd64.tar.gz", "go1.22.1.linux-amd64.tar.gz"),
                                "" => go::install_go_on_alma_linux("https://go.dev/dl/go1.22.1.linux-amd64.tar.gz", "go1.22.1.linux-amd64.tar.gz"),
                                "latest" => go::install_go_on_alma_linux("https://go.dev/dl/go1.22rc2.linux-amd64.tar.gz", "go1.22rc2.linux-amd64.tar.gz"),
                                &_ => go::install_go_error()
                            }
                        },
                        "alpine" => go::install_go_on_alpine_linux("https://go.dev/dl/go1.22.1.linux-amd64.tar.gz", "go1.22.1.linux-amd64.tar.gz"),
                        &_ => null_var = "none".to_string()
                    }
    ...
    fn install_nodejs(&self) -> Self {
        if self.first_arg == CommandType::Install && self.second_arg == "node".to_string() {
            match self.os_type {
                OsType::Windows => {
                    match self.third_arg.as_str() {
                        "lts" => node::install_nodejs_on_windows("https://nodejs.org/dist/v20.12.0/node-v20.12.0-x64.msi", "node-v20.12.0-x64.msi"),
                        "" => node::install_nodejs_on_windows("https://nodejs.org/dist/v20.12.0/node-v20.12.0-x64.msi", "node-v20.12.0-x64.msi"),
                        "latest" => node::install_nodejs_on_windows("https://nodejs.org/dist/v21.7.1/node-v21.7.1-x64.msi", "node-v21.7.1-x64.msi"),
                ...
                OsType::Linux => {
                    ...
                    match linux_dist {
                        "ubuntu" => {
                            match self.third_arg.as_str() {
                                "lts" => node::install_nodejs_on_debian_based_distros("https://nodejs.org/dist/v20.12.0/node-v20.12.0-linux-x64.tar.xz", "node-v20.12.0-linux-x64.tar.xz"),
                                "" => node::install_nodejs_on_debian_based_distros("https://nodejs.org/dist/v20.12.0/node-v20.12.0-linux-x64.tar.xz", "node-v20.12.0-linux-x64.tar.xz"),
                                "latest" => node::install_nodejs_on_debian_based_distros("https://nodejs.org/dist/v21.7.1/node-v21.7.1-linux-x64.tar.xz", "node-v21.7.1-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        },
                        "debian" => {
                        ...
                        "arch wsl" => {
                            match self.third_arg.as_str() {
                                "lts" => node::install_nodejs_on_arch_linux("https://nodejs.org/dist/v20.12.0/node-v20.12.0-linux-x64.tar.xz", "node-v20.12.0-linux-x64.tar.xz"),
                                "" => node::install_nodejs_on_arch_linux("https://nodejs.org/dist/v20.12.0/node-v20.12.0-linux-x64.tar.xz", "node-v20.12.0-linux-x64.tar.xz"),
                                "latest" => node::install_nodejs_on_arch_linux("https://nodejs.org/dist/v21.7.1/node-v21.7.1-linux-x64.tar.xz", "node-v21.7.1-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        }
                        "kali linux" => {
                        ...
                        "fedora" => {
                            match self.third_arg.as_str() {
                                "lts" => node::install_nodejs_on_centos_and_fedora("https://nodejs.org/dist/v20.12.0/node-v20.12.0-linux-x64.tar.xz", "node-v20.12.0-linux-x64.tar.xz"),
                                "" => node::install_nodejs_on_centos_and_fedora("https://nodejs.org/dist/v20.12.0/node-v20.12.0-linux-x64.tar.xz", "node-v20.12.0-linux-x64.tar.xz"),
                                "latest" => node::install_nodejs_on_centos_and_fedora("https://nodejs.org/dist/v21.7.1/node-v21.7.1-linux-x64.tar.xz", "node-v21.7.1-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        },
                        "centos" => {
                        ...
                        "alma linux" => {
                            match self.third_arg.as_str() {
                                "lts" => node::install_nodejs_on_alma_linux("https://nodejs.org/dist/v20.12.0/node-v20.12.0-linux-x64.tar.xz", "node-v20.12.0-linux-x64.tar.xz"),
                                "" => node::install_nodejs_on_alma_linux("https://nodejs.org/dist/v20.12.0/node-v20.12.0-linux-x64.tar.xz", "node-v20.12.0-linux-x64.tar.xz"),
                                "latest" => node::install_nodejs_on_alma_linux("https://nodejs.org/dist/v21.7.1/node-v21.7.1-linux-x64.tar.xz", "node-v21.7.1-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        },
