            ...
            match self.os_type {
                OsType::Windows => {
                    match self.third_arg.as_str() {
                        ...
                        "latest" => node::install_nodejs_on_windows("https://nodejs.org/dist/v23.3.0/node-v23.3.0-x64.msi", "node-v23.3.0-x64.msi"),
                    ...
                    match linux_dist {
                        "ubuntu" => {
                            match self.third_arg.as_str() {
                                ...
                                "latest" => node::install_nodejs_on_debian_based_distros("https://nodejs.org/dist/v23.3.0/node-v23.3.0-linux-x64.tar.xz", "node-v23.3.0-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        },
                        "debian" => {
                        ...
                        "arch wsl" => {
                            match self.third_arg.as_str() {
                                ...
                                "latest" => node::install_nodejs_on_arch_linux("https://nodejs.org/dist/v23.3.0/node-v23.3.0-linux-x64.tar.xz", "node-v23.3.0-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        }
                        "kali linux" => {
                        ...
                        "fedora" => {
                            match self.third_arg.as_str() {
                                ...
                                "latest" => node::install_nodejs_on_centos_and_fedora("https://nodejs.org/dist/v23.3.0/node-v23.3.0-linux-x64.tar.xz", "node-v23.3.0-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        },
                        "centos" => {
                        ...
                        "rocky" => {
                            match self.third_arg.as_str() {
                                ...
                                "latest" => node::install_nodejs_on_rocky_linux("https://nodejs.org/dist/v23.3.0/node-v23.3.0-linux-x64.tar.xz", "node-v23.3.0-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        },
                        "alma linux" => {
                            match self.third_arg.as_str() {
                                ...
                                "latest" => node::install_nodejs_on_alma_linux("https://nodejs.org/dist/v23.3.0/node-v23.3.0-linux-x64.tar.xz", "node-v23.3.0-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        },
