            ...
            match self.os_type {
                OsType::Windows => {
                    match self.third_arg.as_str() {
                        "lts" => go::install_go_on_windows(&self.env_confs, "https://go.dev/dl/go1.25.5.windows-amd64.msi", "go1.25.5.windows-amd64.msi"),
                        "" => go::install_go_on_windows(&self.env_confs, "https://go.dev/dl/go1.25.5.windows-amd64.msi", "go1.25.5.windows-amd64.msi"),
                        "latest" => go::install_go_on_windows(&self.env_confs, "https://go.dev/dl/go1.26rc1.windows-amd64.msi", "go1.26rc1.windows-amd64.msi"),
                ...
                OsType::Linux => {
                    ...
                    match linux_dist {
                        "ubuntu" => {
                            match self.third_arg.as_str() {
                                "lts" => go::install_go_on_debian_based_distros(&self.env_confs, "https://go.dev/dl/go1.25.5.linux-amd64.tar.gz", "go1.25.5.linux-amd64.tar.gz"),
                                "" => go::install_go_on_debian_based_distros(&self.env_confs, "https://go.dev/dl/go1.25.5.linux-amd64.tar.gz", "go1.25.5.linux-amd64.tar.gz"),
                                "latest" => go::install_go_on_debian_based_distros(&self.env_confs, "https://go.dev/dl/go1.26rc1.linux-amd64.tar.gz", "go1.26rc1.linux-amd64.tar.gz"),
                                &_ => go::install_go_error()
                            }
                        },
                        "debian" => {
                        ...
                        "arch wsl" => {
                            match self.third_arg.as_str() {
                                "lts" => go::install_go_on_arch_linux(&self.env_confs, "https://go.dev/dl/go1.25.5.linux-amd64.tar.gz", "go1.25.5.linux-amd64.tar.gz"),
                                "" => go::install_go_on_arch_linux(&self.env_confs, "https://go.dev/dl/go1.25.5.linux-amd64.tar.gz", "go1.25.5.linux-amd64.tar.gz"),
                                "latest" => go::install_go_on_arch_linux(&self.env_confs, "https://go.dev/dl/go1.26rc1.linux-amd64.tar.gz", "go1.26rc1.linux-amd64.tar.gz"),
                                &_ => go::install_go_error()
                            }
                        }
                        "kali linux" => {
                        ...
                        "fedora" => {
                            match self.third_arg.as_str() {
                                "lts" => go::install_go_on_centos_and_fedora(&self.env_confs, "https://go.dev/dl/go1.25.5.linux-amd64.tar.gz", "go1.25.5.linux-amd64.tar.gz"),
                                "" => go::install_go_on_centos_and_fedora(&self.env_confs, "https://go.dev/dl/go1.25.5.linux-amd64.tar.gz", "go1.25.5.linux-amd64.tar.gz"),
                                "latest" => go::install_go_on_centos_and_fedora(&self.env_confs, "https://go.dev/dl/go1.26rc1.linux-amd64.tar.gz", "go1.26rc1.linux-amd64.tar.gz"),
                                &_ => go::install_go_error()
                            }
                        },
                        "centos" => {
                        ...
                        "rocky" => {
                            match self.third_arg.as_str() {
                                "lts" => go::install_go_on_rocky_linux(&self.env_confs, "https://go.dev/dl/go1.25.5.linux-amd64.tar.gz", "go1.25.5.linux-amd64.tar.gz"),
                                "" => go::install_go_on_rocky_linux(&self.env_confs, "https://go.dev/dl/go1.25.5.linux-amd64.tar.gz", "go1.25.5.linux-amd64.tar.gz"),
                                "latest" => go::install_go_on_rocky_linux(&self.env_confs, "https://go.dev/dl/go1.26rc1.linux-amd64.tar.gz", "go1.26rc1.linux-amd64.tar.gz"),
                                &_ => go::install_go_error()
                            }
                        }
                        "alma linux" => {
                            match self.third_arg.as_str() {
                                "lts" => go::install_go_on_alma_linux(&self.env_confs, "https://go.dev/dl/go1.25.5.linux-amd64.tar.gz", "go1.25.5.linux-amd64.tar.gz"),
                                "" => go::install_go_on_alma_linux(&self.env_confs, "https://go.dev/dl/go1.25.5.linux-amd64.tar.gz", "go1.25.5.linux-amd64.tar.gz"),
                                "latest" => go::install_go_on_alma_linux(&self.env_confs, "https://go.dev/dl/go1.26rc1.linux-amd64.tar.gz", "go1.26rc1.linux-amd64.tar.gz"),
                                &_ => go::install_go_error()
                            }
                        },
                        "alpine" => (),
    ...
    fn install_nodejs(&self) -> &Self {
        if self.first_arg == CommandType::Install && self.second_arg == "node".to_string() {
            match self.os_type {
                OsType::Windows => {
                    match self.third_arg.as_str() {
                        "lts" => node::install_nodejs_on_windows(&self.env_confs, "https://nodejs.org/dist/v24.13.0/node-v24.13.0-x64.msi", "node-v24.13.0-x64.msi"),
                        "" => node::install_nodejs_on_windows(&self.env_confs, "https://nodejs.org/dist/v24.13.0/node-v24.13.0-x64.msi", "node-v24.13.0-x64.msi"),
                        "latest" => node::install_nodejs_on_windows(&self.env_confs, "https://nodejs.org/dist/v25.3.0/node-v25.3.0-x64.msi", "node-v25.3.0-x64.msi"),
                ...
                OsType::Linux => {
                    ...
                    match linux_dist {
                        "ubuntu" => {
                            match self.third_arg.as_str() {
                                "lts" => node::install_nodejs_on_debian_based_distros(&self.env_confs, "https://nodejs.org/dist/v24.13.0/node-v24.13.0-linux-x64.tar.xz", "node-v24.13.0-linux-x64.tar.xz"),
                                "" => node::install_nodejs_on_debian_based_distros(&self.env_confs, "https://nodejs.org/dist/v24.13.0/node-v24.13.0-linux-x64.tar.xz", "node-v24.13.0-linux-x64.tar.xz"),
                                "latest" => node::install_nodejs_on_debian_based_distros(&self.env_confs, "https://nodejs.org/dist/v25.3.0/node-v25.3.0-linux-x64.tar.xz", "node-v25.3.0-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        },
                        "debian" => {
                        ...
                        "arch wsl" => {
                            match self.third_arg.as_str() {
                                "lts" => node::install_nodejs_on_arch_linux(&self.env_confs, "https://nodejs.org/dist/v24.13.0/node-v24.13.0-linux-x64.tar.xz", "node-v24.13.0-linux-x64.tar.xz"),
                                "" => node::install_nodejs_on_arch_linux(&self.env_confs, "https://nodejs.org/dist/v24.13.0/node-v24.13.0-linux-x64.tar.xz", "node-v24.13.0-linux-x64.tar.xz"),
                                "latest" => node::install_nodejs_on_arch_linux(&self.env_confs, "https://nodejs.org/dist/v25.3.0/node-v25.3.0-linux-x64.tar.xz", "node-v25.3.0-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        }
                        "kali linux" => {
                        ...
                        "fedora" => {
                            match self.third_arg.as_str() {
                                "lts" => node::install_nodejs_on_centos_and_fedora(&self.env_confs, "https://nodejs.org/dist/v24.13.0/node-v24.13.0-linux-x64.tar.xz", "node-v24.13.0-linux-x64.tar.xz"),
                                "" => node::install_nodejs_on_centos_and_fedora(&self.env_confs, "https://nodejs.org/dist/v24.13.0/node-v24.13.0-linux-x64.tar.xz", "node-v24.13.0-linux-x64.tar.xz"),
                                "latest" => node::install_nodejs_on_centos_and_fedora(&self.env_confs, "https://nodejs.org/dist/v25.3.0/node-v25.3.0-linux-x64.tar.xz", "node-v25.3.0-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        },
                        "centos" => {
                        ...
                        "rocky" => {
                            match self.third_arg.as_str() {
                                "lts" => node::install_nodejs_on_rocky_linux(&self.env_confs, "https://nodejs.org/dist/v24.13.0/node-v24.13.0-linux-x64.tar.xz", "node-v24.13.0-linux-x64.tar.xz"),
                                "" => node::install_nodejs_on_rocky_linux(&self.env_confs, "https://nodejs.org/dist/v24.13.0/node-v24.13.0-linux-x64.tar.xz", "node-v24.13.0-linux-x64.tar.xz"),
                                "latest" => node::install_nodejs_on_rocky_linux(&self.env_confs, "https://nodejs.org/dist/v25.3.0/node-v25.3.0-linux-x64.tar.xz", "node-v25.3.0-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        },
                        "alma linux" => {
                            match self.third_arg.as_str() {
                                "lts" => node::install_nodejs_on_alma_linux(&self.env_confs, "https://nodejs.org/dist/v24.13.0/node-v24.13.0-linux-x64.tar.xz", "node-v24.13.0-linux-x64.tar.xz"),
                                "" => node::install_nodejs_on_alma_linux(&self.env_confs, "https://nodejs.org/dist/v24.13.0/node-v24.13.0-linux-x64.tar.xz", "node-v24.13.0-linux-x64.tar.xz"),
                                "latest" => node::install_nodejs_on_alma_linux(&self.env_confs, "https://nodejs.org/dist/v25.3.0/node-v25.3.0-linux-x64.tar.xz", "node-v25.3.0-linux-x64.tar.xz"),
                                &_ => node::install_nodejs_error()
                            }
                        },
                        "alpine" => (),
